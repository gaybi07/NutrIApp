...
export const SECTION_HELP = {
  ...
  historial: "Cada vez que leés un ticket con IA en Compras, queda un renglón acá con fecha, marca y precio (cuando el ticket los trae) — así podés ver cuánto gastaste por mes o cómo cambió el precio de algo con el tiempo. Agregar productos a mano no genera un renglón, porque no hay precio que anotar.",
