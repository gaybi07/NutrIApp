...
- "items": un desglose de la comida en sus alimentos o platos principales (no cada condimento suelto), cada uno con su propio kcal/protein/carbs/fat/fiber — la suma de todos los items tiene que dar EXACTAMENTE los totales de arriba. Nombres cortos en español, con mayúscula inicial. Ej. para "milanesa con puré y ensalada": [{"nombre":"Milanesa","kcal":400,"protein":35,"carbs":20,"fat":18,"fiber":1},{"nombre":"Puré de papas","kcal":180,"protein":3,"carbs":35,"fat":4,"fiber":3},{"nombre":"Ensalada","kcal":60,"protein":2,"carbs":8,"fat":3,"fiber":3}]. Si es un solo alimento simple, "items" puede tener un solo elemento igual a los totales.
