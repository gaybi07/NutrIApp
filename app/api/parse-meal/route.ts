...
- "items": un desglose de la comida en sus alimentos o platos principales (no cada condimento suelto), cada uno con su propio kcal/protein/carbs/fat/fiber — la suma de todos los items tiene que dar EXACTAMENTE los totales de arriba. Nombres cortos en español, con mayúscula inicial, SIEMPRE con la cantidad aproximada entre paréntesis (gramos, unidades o mililitros — la que tenga más sentido para ese alimento) para que se entienda de un vistazo qué porción es cada kcal, sin tener que ir a mirar "ingredientes". Ej. para "milanesa con puré y ensalada": [{"nombre":"Milanesa (150 g)","kcal":400,"protein":35,"carbs":20,"fat":18,"fiber":1},{"nombre":"Puré de papas (200 g)","kcal":180,"protein":3,"carbs":35,"fat":4,"fiber":3},{"nombre":"Ensalada (100 g)","kcal":60,"protein":2,"carbs":8,"fat":3,"fiber":3}]. Si es un solo alimento simple, "items" puede tener un solo elemento igual a los totales, con su cantidad igual.
- Respondé SOLO con un JSON válido, sin texto adicional, sin backticks, con este formato exacto:
{"kcal": <numero entero>, "protein": <numero entero, gramos>, "carbs": <numero entero, gramos>, "fat": <numero entero, gramos>, "fiber": <numero entero, gramos>, "detalle": "<breve desglose de 1 linea, en español>", "resumen": "<titulo corto>", "ingredientes": "<listado para inventario>", "items": [{"nombre": "<string>", "kcal": <int>, "protein": <int>, "carbs": <int>, "fat": <int>, "fiber": <int>}]}`;
